...
<head>
    ...
    <link rel="stylesheet" href="pscss.css">
...
<body>
        ...
        <div id="gift">
            <div id="gifts">
                <div><img id="cards" src="img/giftcardps10.jpg" alt=""><h3>Gift Card 10€</h3><p>9,99€</p><input type="submit" value="Comprar"></div>
                <div><img id="cards" src="img/giftcardps20.jpg" alt=""><h3>Gift Card 20€</h3><p>19,99€</p><input type="submit" value="Comprar"></div>
                <div><img id="cards" src="img/giftcardps50.jpg" alt=""><h3>Gift Card 50€</h3><p>49,99€</p><input type="submit" value="Comprar"></div>
                <div><img id="cards" src="img/giftcardps80.jpg" alt=""><h3>Gift Card 80€</h3><p>79,99€</p><input type="submit" value="Comprar"></div>
            </div>
        </div>
        <footer id="footer">
